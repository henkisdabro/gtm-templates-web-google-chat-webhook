    ...
    "valueValidators": [
      {
        ...
        "errorMessage": "Please enter a valid Google Chat Webhook URL starting with https://chat.googleapis.com"
      },
      {
        "type": "NON_EMPTY"
      }
...
const postScriptUrl = 'https://cdn.jsdelivr.net/gh/henkisdabro/gtm-templates-web-google-chat-webhook@main/googlechat-postRequest.js'; 
      ...
      "param": [
        {
          ...
          "value": {
            ...
            "listItem": [
              {
                "type": 1,
                "string": "https://cdn.jsdelivr.net/gh/henkisdabro/gtm-templates-web-google-chat-webhook@main/googlechat-postRequest.js"
              }
            ]
          }
        }
